...
function Order() {
  ...
  function downloadBill() {
    const screen = document.querySelector('.bill-order');
    setLoader(true);
  ...
  return (
    <div className="order-comp mt-24 space-y-8 p-14 bg-stone-50 w-full max-w-2xl border rounded-xl sm:px-16">
      <div className="bill-order flex flex-col gap-10">
      ...
      <div className="download flex justify-center">
        <Button 
          ...
          color="transparent hover:bg-yellow-400 border-2 border-yellow-500"
          px="px-6"
          py="py-2"
